...
label = []
ReadMyCsv2(label, "usoskinlabel1.csv",1)
SMat = []
ReadMyCsv(SMat, "LogSigmoidusoskin.csv")
...
storFile(MatrixDense, 'LogusoskinMatrixDense.csv')
# print(len(MatrixDense[0]))
# print(len(MatrixDense))
# print(y.shape)
# print(type(y_test))
# print(type(y))
storFile2(y,'LogusoskinLabelDense.csv')