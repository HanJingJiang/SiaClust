...
label = []
ReadMyCsv2(label, "kolodziejczyklabel.csv",1)
SMat = []
ReadMyCsv(SMat, "LogSigmoidkolo.csv")
...
storFile(MatrixDense, 'LogkoloMatrixDense.csv')
# print(len(MatrixDense[0]))
# print(len(MatrixDense))
# print(y.shape)
# print(type(y_test))
# print(type(y))
storFile2(y,'LogkoloLabelDense.csv')