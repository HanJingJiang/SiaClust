...
label = []
ReadMyCsv2(label, "biaseLabel.csv",1)
SMat = []
ReadMyCsv(SMat, "LogSigmoidbiase.csv")
...
storFile(MatrixDense, 'BiaseMatrixDense.csv')
# print(len(MatrixDense[0]))
# print(len(MatrixDense))
# print(y.shape)
# print(type(y_test))
# print(type(y))
storFile2(y, 'BiaseLabelDense.csv')