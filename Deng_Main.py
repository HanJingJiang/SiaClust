...
label = []
ReadMyCsv2(label, "deng6.csv",1)
SMat = []
ReadMyCsv(SMat, "LogSigmoiddeng.csv")
...
storFile(MatrixDense, 'LogDengMatrixDense.csv')
# print(len(MatrixDense[0]))
# print(len(MatrixDense))
# print(y.shape)
# print(type(y_test))
# print(type(y))
storFile2(y,'LogDengLabelDense.csv')