...
label = []
ReadMyCsv2(label, "li-Label.csv",1)
SMat = []
ReadMyCsv(SMat, "LogSigmoidLi.csv")
...
storFile(MatrixDense, 'LiMatrixDense.csv')
# print(len(MatrixDense[0]))
# print(len(MatrixDense))
# print(y.shape)
# print(type(y_test))
# print(type(y))
storFile2(y, 'LiLabelDense.csv')