...
label = []
ReadMyCsv2(label, "GoolamLabel.csv",1)
SMat = []
ReadMyCsv(SMat, "LogSigmoidGoolam.csv")
...
storFile(MatrixDense, 'LogGoolamMatrixDense.csv')
# print(len(MatrixDense[0]))
# print(len(MatrixDense))
# print(y.shape)
# print(type(y_test))
# print(type(y))
storFile2(y,'LogGoolamLabelDense.csv')