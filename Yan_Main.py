...
label = []
ReadMyCsv2(label, "yanlabel.csv",1)
SMat = []
ReadMyCsv(SMat, "LogSigmoidYan.csv")
...
storFile(MatrixDense, 'LogYanMatrixDense.csv')
# print(len(MatrixDense[0]))
# print(len(MatrixDense))
# print(y.shape)
# print(type(y_test))
# print(type(y))
storFile2(y,'LogYanLabelDense.csv')